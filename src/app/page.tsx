    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center z-0 select-none opacity-20 pointer-events-none absolute inset-0">
          <h1 className="text-[20vw] md:text-[22vw] leading-[0.75] font-black tracking-tighter text-foreground text-center">
            ODYS
          </h1>
          <h1 className="text-[20vw] md:text-[22vw] leading-[0.75] font-black tracking-tighter text-foreground text-center">
            SEUS
        ...
        {/* Central Compass */}
        <div className="absolute top-[30%] md:top-[42%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
          <InteractiveCompass className="w-[50vw] md:w-[28vw] h-[50vw] md:h-[28vw] min-w-[200px] min-h-[200px] md:min-w-[280px] md:min-h-[280px] text-secondary drop-shadow-2xl" />
        </div>

        {/* Subtext */}
        <div className="absolute bottom-36 left-4 md:bottom-12 md:left-12 z-30 max-w-[260px] md:max-w-sm">
          <h2 className="text-base md:text-2xl font-bold uppercase leading-tight mb-2 md:mb-4 drop-shadow-sm text-foreground">
        ...
        <div className="absolute bottom-16 md:bottom-12 left-1/2 -translate-x-1/2 z-30">
            <Link href="/login">
              <button className="px-6 py-2.5 md:px-8 md:py-3 text-sm md:text-base bg-juice-orange text-juice-cream font-bold uppercase tracking-widest rounded-full hover:scale-105 transition-transform shadow-lg">
                Get Started
              </button>
            </Link>
        </div>
        ...
        {/* Footer Details */}
        <div className="absolute bottom-3 right-4 md:bottom-8 md:right-8 text-[10px] md:text-sm font-mono opacity-60 uppercase tracking-widest text-right z-30 text-foreground">
          Designed by <br />
